<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="itemTemplate14.aspx.cs" Inherits="CC.itemTemplate14" %>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td style="text-align: center; width:350px; height:350px" rowspan="2">
                        <asp:Image ID="Image1" runat="server" Height="315px" Width="270px" ImageUrl="~/hnm9.jpg"/>
                    </td>
                ...
                <tr>
                    <td style =" width:160px; height:100px; text-align: center; vertical-align: middle; padding-left:90px">
                        <asp:ImageButton ID="ImageButton2" runat="server" Height="52px" Width="59px" ImageUrl="~/hnm10.jpg"/>
                        <asp:ImageButton ID="ImageButton3" runat="server" Height="52px" Width="59px" ImageUrl="~/hnm11.jpg"/>
                        <asp:ImageButton ID="ImageButton4" runat="server" Height="52px" Width="59px" ImageUrl="~/hnm12.jpg"/>
                    </td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
